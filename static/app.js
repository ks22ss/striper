...
(function () {
  ...
  function getScoreDisplayInfo(score) {
    ...
    const progressClass = score < SCORE_OPTIMAL ? 'progress-success' :
      score < SCORE_REDUNDANT ? 'progress-warning' : 'progress-error';
    const label = score < SCORE_OPTIMAL ? 'prompt is fairly optimal' :
      score < SCORE_REDUNDANT ? 'some redundancy detected' : 'prompt is over-engineered';
