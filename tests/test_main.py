...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["landing-page", "Get started", "login-page", "register-page"]),
    ...
    ids=[
        ...
        "reload_history_keyboard_shortcut",
        "over_engineered_explanation_section",
    ],
)
def test_ui_includes_elements(expected_strings):
